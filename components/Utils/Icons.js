...
export function ArrowDown({ fill = 'bright-red', h = '4px', w = '8px' }) {
    return (
        <Icon
            fill={fill}
            width={w}
...
export function ArrowUp({ fill = 'lime-green', h = '4px', w = '8px' }) {
    return (
        <Icon
            fill={fill}
            width={w}
...
export function Facebook({ h = '20px', w = '20px' }) {
    return (
        <Icon
            width={w}
            height={h}
...
export function Instagram({ h = '20px', w = '20px' }) {
    return (
        <Icon
            width={w}
            height={h}
...
export function Twitter({ h = '17px', w = '20px' }) {
    return (
        <Icon
            width={w}
            height={h}
